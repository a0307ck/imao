...
public class CodeGenerator {
	 ...
	 public static final String BASE_PACKAGE = "com.imao.auth";//生成代码所在的基础包名称，可根据自己公司的项目修改（注意：这个配置修改之后需要手工修改src目录项目默认的包路径，使其保持一致，不然会找不到类）
    ...
    private static final String AUTHOR = "ChineseKam";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
//        genCode("product");
        genCodeByCustomModelName("sys_log","SysLog");
    }
...
//        context.addPluginConfiguration(pluginConfiguration);
        ...
        commentGeneratorConfiguration.setConfigurationType("com.imao.code.MyCommentGenerator");
